...
(0, _jquery2.default)(function () {
  var jWindow = (0, _jquery2.default)(window);

  var sidebarVisible = false;

  var body = (0, _jquery2.default)('body');

  (0, _jquery2.default)('#menu-reveal').click(function () {
  ...
  (0, _jquery2.default)('.section-link').click(function () {
    body.removeClass('menuOpen');
